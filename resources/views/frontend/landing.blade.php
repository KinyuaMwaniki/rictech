    ...
    <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
        <div class="container d-flex">
            <div class="contact-info mr-auto">
                <i class="icofont-envelope"></i> <a href="mailto:{{ $company_detail->email }}">{{ $company_detail->email }}</a>
                <i class="icofont-phone"></i> {{ $company_detail->mobile }}
            </div>
            <div class="social-links">
                <a href="http://{{ $company_detail->twitter }}" target="_blank" class="twitter"><i class="icofont-twitter"></i></a>
                <a href="http://{{ $company_detail->facebook }}" target="_blank" class="facebook"><i class="icofont-facebook"></i></a>
                <a href="http://{{ $company_detail->instagram }}" target="_blank" class="instagram"><i class="icofont-instagram"></i></a>
            </div>
        </div>
    </div>
